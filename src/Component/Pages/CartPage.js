...
//           </ModalBody>
//           <ModalFooter>
//             <Button color="primary" onClick={this.toggle}><Link to="/" style={{color: 'white'}}>Do Something</Link></Button>{' '}
//             <Button color="secondary" onClick={this.toggle}><Link to="/" style={{color: 'white'}}>Cancel</Link></Button>
//           </ModalFooter>
//         </Modal>
//       </div>
//     );
