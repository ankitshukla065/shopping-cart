...
import { Card, CardImg, CardTitle,
    CardSubtitle, CardBody, Input, Button, Collapse, InputGroup, InputGroupAddon } from 'reactstrap';
    ...
    render(){
        ...
        return(
                ...
                <Link to={"/product/" + product._id}>
                    <CardImg id={"ShopCardImg" + product._id} top width="100%" src={product.image} alt="Card image cap" />
                    ...
                    <InputGroup id={"ShopCardInputGroup" + product._id}>
                        ...
                        <InputGroupAddon id={"ShopCardInputGroupAddOn" + product._id} addonType="append">
                            <Button id={"ShopCardButton" + product._id} size="lg" color="success" onClick={() => this.props.addProduct(product, this.func(product._id))}>Add to Cart</Button>
                        </InputGroupAddon>
                    </InputGroup>
                    </Collapse> 
                </Card>
